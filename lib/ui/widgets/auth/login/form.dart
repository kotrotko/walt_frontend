...
class LoginFormState extends State<LoginForm> {
  ...
  final TextInputType keyboardTypePhone = TextInputType.phone;
  ...
  switchPasswordVisibility() {
    ...
    Widget inputFieldLogin(bool _passwordVisible, TextInputType keyboardType, Container suffixContainer, TextEditingController controller, String validationMessage) {
                  ...
                  Container(
                    ...
                    child: Form(
                      ...
                      child: Column(children: <Widget>[
                        inputFieldLogin(_passwordVisible, TextInputType.phone, suffixInvisible, _emailController,  "Enter"),
                        inputFieldLogin(_passwordVisible, keyboardTypePassword, suffixVisible, _passwordController,  "Enter password"),
                        Column(
                            children: <Widget>[
                              Container(
                                            ...
                                            if (loginResponse.statusCode == 200)
                                              {
                                                ...
                                                Navigator.push(
                                                  ...
                                                  new MaterialPageRoute(
                                                    builder: (context) => new ItemRegistration(),
                                                  ),
                                                );*/
                                                  Navigator.pushReplacementNamed(
                                                      context, SuccessScreen.routeName,
                                                      //context, RealtyInputDescription.routeName,
                                                      //context, InputMapPage.routeName,
